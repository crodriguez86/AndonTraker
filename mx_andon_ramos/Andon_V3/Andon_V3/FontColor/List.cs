...
namespace Andon_V3.FontColor
{
    public partial class List : Form
    {
        ...
        private void loadData()
        {
            ...
            List<ColorText> list = objBLL.getColorText(new ColorText());
            if (list != null)
            {
            ...
            {
                ShowWarning("No se pudieron cargar colores de fuente de base datos");
            }
        ...
        private void grdLines_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
...

                {
                    ...
                    {
                        ColorTextBLL lineBLL = new ColorTextBLL();
                        if (lineBLL.deleteColorText(Convert.ToInt32(val)))
