...
namespace Andon_V3.AndonConfig2
{
    public partial class List : Form
    {
        ...
        {
            AndonBLL objBLL = new AndonBLL();
            grdData.AutoGenerateColumns = false;
            List<AndonConfig> list = objBLL.getAndonConfig(new AndonConfig());
            if (list != null)
            {
            ...
            {
                ShowWarning("No se pudo cargar Andon Config de base datos");
            }
        ...
        private void grdLines_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
...

                {
                    ...
                    {
                        AndonBLL objBLL = new AndonBLL();
                        if (objBLL.deleteAndonConfig(Convert.ToInt32(val)))
        ...
        private void grdLines_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            ...
            {
                grdData[9, i].Value = "Update";
                grdData[10, i].Value = "Delete";
            }
        }
