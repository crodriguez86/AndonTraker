...
namespace Andon_V3.Fonsize
{
    public partial class List : Form
    {
        ...
        private void loadData()
        {
            ...
            List<AndonFontsize> list = objBLL.getAndonFontsize(new AndonFontsize());
            if (list != null)
            {
            ...
            {
                ShowWarning("No se pudieron cargar colores de fondo de base datos");
            }
        ...
        private void grdLines_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
...

                {
                    ...
                    {
                        FontsizeBLL lineBLL = new FontsizeBLL();
                        if (lineBLL.deleteAndonFontsize(Convert.ToInt32(val)))
        ...
        private void grdLines_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            ...
            {
                grdData[2, i].Value = "Update";
                grdData[3, i].Value = "Delete";
            }
        }
